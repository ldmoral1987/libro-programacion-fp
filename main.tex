...
\noindent \newline Contribuye al ahorro de papel. No imprimas el libro si no es necesario.
\newline
...
%	PARTE I
%----------------------------------------------------------------------------------------
\input{parte1.tex} % Se incluye la parte I
...
\addcontentsline{toc}{chapter}{\textcolor{ocre}{Índice de términos}} % Añade el encabezado del índice en el índice de contenidos
