...
\noindent \textsc{Versión 1.0}\\ % Publisher

\noindent \textsc{book-website.com}\\ % URL

\noindent Licenciado según la licencia Creative Commons Atribución-NoComercial 4.0 Internacional (CC BY-NC 4.0). Puede obtener una copia de la licencia en \url{https://creativecommons.org/licenses/by-nc-sa/4.0/}.

\noindent \textit{Febrero de 2021} % Printing/edition date
